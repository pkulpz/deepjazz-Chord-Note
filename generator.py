...
def generate(data_fn_list, data_para_list, out_fn, N_epochs):
    # model settings
    max_len = 20
    max_tries = 1000
    diversity = 0.5
    ...
    # get data
    chords, abstract_grammars = get_musical_data(data_fn_list,data_para_list)
    ...
    def play(x): return midi.realtime.StreamPlayer(x).play()
    #play(out_stream)
...
def main(args):
    ...
    generate(data_fn_list, data_para_list, out_fn, N_epochs)
